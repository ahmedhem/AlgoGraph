function dragElement(draggableElement) {
    let newPositionX = 0, newPositionY = 0, oldPositionX = 0, oldPositionY = 0;
    ...
    function elementDrag(e) {
        ...
        draggableElement.style.top = (draggableElement.offsetTop - newPositionY) + "px";
        draggableElement.style.left = (draggableElement.offsetLeft - newPositionX) + "px";
    }
