...
export function edgePopup(edge) {
    ...
    /***** The Main three rows  *****/
    addElements(theContainer, "div", "div", "Start Node", "End Node", ["header"], ["header"]);
    addElements(theContainer, "div", "div", edge.start, edge.end, ["edge-info"], ["edge-info"]);
    addElements(theContainer, "div", null, "Weights", null, ["header"], null);

    /*****Weights******/
    let weight = edge.weights;
    for (let i of weight) {
        addElements(theContainer, "div", "button", i, "Delete Weight", ["edge-info"], ["edge-info", "removeEdgeBtn"], edge);
    }
...
function addElements(parent, left, right, leftText, rightText, leftClass, rightClass, edge) {
